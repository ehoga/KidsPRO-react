...
function Home(){
    return(
        ...
        <section class="banner">
            <div class="wrapper">
                ...
                <div class="navigation">
                    ...
                    <a class="button" href="https://youtu.be/ypH95fDolFk?si=zkhj4iL02g1Chhhx">Aulas</a>
                </div>   
            </div>       
        </section>   
        ...
        <form id="contatos" class="form">
            <legend class="title -second">Contatos</legend>
            
            <label class="label-form" for="name">Nome</label>
            <input class="barra-input" id="name" type="text" required />
    
            <label class="label-form" for="email">Email</label>
            <input class="barra-input" id="email" type="email" required />
    
            <label class="label-form" for="message">Mensagem</label>
            <textarea class="barra-input -textarea" id="message" required></textarea>
